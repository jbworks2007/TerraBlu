...
import { AiOutlineSelect, AiFillThunderbolt } from 'react-icons/ai'
...
export default function Electricity() {
  ...
  const initialValues = {
    ...
    energy: 'Select Renewable Energy',
    value: 0
  }
  ...
  return (
    <>
      <div className="head-active">
        <AiFillThunderbolt size={18} className='ico-color' />
        &nbsp;Electricity
      </div>
      <div className='sub-title'>
        Electricity used by an organisation at sites owned/controlled by them. For renewable energy contracts, the emissions are equal to zero.
      </div>
                ...
                <div className="col-lg-11">
                  <div className="row mt-1">
                    ...
                    <div className="col-lg-4">
                      <div className="">
                        <div className="input-with">
                          <div className="form-label">Renewable Energy</div>
                          <Dropdown>
                            <Dropdown.Toggle className="dropdown-one d-flex justify-content-between align-items-center">
                              <div><AiOutlineSelect size={18} className='ico-color' /></div>
                              <div>{key.energy}</div>
                            ...
                            <Dropdown.Menu className='dd-menu-one'>
                              <Dropdown.Item className='dd-one-items' onClick={() => { setData("Item-1", index, 'energy'); }}>Item-1</Dropdown.Item>
                              <Dropdown.Item className='dd-one-items' onClick={() => { setData("Item-2", index, 'energy'); }}>Item-2</Dropdown.Item>
                              <Dropdown.Item className='dd-one-items' onClick={() => { setData("Item-3", index, 'energy'); }}>Item-3</Dropdown.Item>
                            </Dropdown.Menu>
                          </Dropdown>
                        </div>
                      </div>
