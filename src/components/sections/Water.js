  ...
  return (
    <>
      <div className="head-active">
        <IoWater size={16} className='ico-color' />
        &nbsp;Water
      </div>
                    ...
                    <div className="col-lg-4">
                      <div className="">
                        <div className="input-with">
                          <div className="form-label">Water</div>
                          <Dropdown>
                            ...
                            <Dropdown.Menu className='dd-menu-one'>
                              <Dropdown.Item className='dd-one-items' onClick={() => { setData("Item-1", index, 'water'); }}>Item-1</Dropdown.Item>
                              <Dropdown.Item className='dd-one-items' onClick={() => { setData("Item-2", index, 'water'); }}>Item-2</Dropdown.Item>
                              <Dropdown.Item className='dd-one-items' onClick={() => { setData("Item-3", index, 'water'); }}>Item-3</Dropdown.Item>
                            </Dropdown.Menu>
                          </Dropdown>
                        </div>
                      </div>
