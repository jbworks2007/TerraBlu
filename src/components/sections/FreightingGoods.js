...
export default function FreightingGoods() {
                ...
                <div className="col-lg-11">
                  <div className="row mt-1 mb-4">
                    ...
                    <div className="col-md-4 col-lg-3">
                      <div className="">
                        ...
                        <div className="input-one">
                          ...
                          <input type="text" className="input-feild-one" value={key.distance} onChange={e => setData(e.target.value, index, 'distance')} />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-md-4 col-lg-3">
                      <div className="">
                        <div className="input-with">
                          <div className="form-label">Weight Unit</div>
                          <Dropdown>
                            <Dropdown.Toggle className="dropdown-one d-flex justify-content-between align-items-center">
                              <div><AiOutlineSelect size={18} className='ico-color' /></div>
                              <div>{key.weiunit}</div>
                            ...
                            <Dropdown.Menu className='dd-menu-one'>
                              <Dropdown.Item className='dd-one-items' onClick={() => { setData("Item-1", index, 'weiunit'); }}>Item-1</Dropdown.Item>
                              <Dropdown.Item className='dd-one-items' onClick={() => { setData("Item-2", index, 'weiunit'); }}>Item-2</Dropdown.Item>
                              <Dropdown.Item className='dd-one-items' onClick={() => { setData("Item-3", index, 'weiunit'); }}>Item-3</Dropdown.Item>
                            </Dropdown.Menu>
                          </Dropdown>
                        </div>
                      </div>
                    ...
                    <div className="col-md-4 col-lg-3">
                      <div className="">
                        <label className="label-one">Weight</label>
                        <div className="input-one">
                          <span className="icon-one">
                            <Bs123 size={20} />
                          </span>
                          <input type="text" className="input-feild-one" value={key.weight} onChange={e => setData(e.target.value, index, 'weight')} />
                        </div>
                      </div>
                    </div>
                    {/* Mapping Ends Here */}
