  ...
  return (
    <>
      <div className="head-active">
        <GiHeatHaze size={18} className='ico-color' />
        &nbsp;Heat & Steam
      </div>
      <div className='sub-title'>
        Emissions within organisations that purchase heat/steam energy for heating purposes or for use in specific industrial processes.
      </div>
